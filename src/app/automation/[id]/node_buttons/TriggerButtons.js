...
const TriggerButtons = ({ automationId, setNodes }) => {
  const addTriggerMutation = useMutation({
    mutationKey: ["addTelegramMessageTrigger", automationId],
    ...
    <Box>
      ...
      <Stack direction="row" spacing={2} overflow="auto">
        <Button
          ...
          onClick={() =>
            addTriggerMutation.mutate(BlockType.TelegramRecieveMessage)
          }
          variant="contained"
          color="primary"
        >
        ...
        <Button
          disabled={addTriggerMutation.isPending}
          onClick={() =>
            addTriggerMutation.mutate(BlockType.APITrigger)
          }
          variant="contained"
          color="primary"
        >
